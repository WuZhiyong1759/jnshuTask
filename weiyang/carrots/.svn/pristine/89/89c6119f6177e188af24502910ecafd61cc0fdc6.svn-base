...
public class DynamicUtil {
  ...
  /**
   * 查询技能树
   * 这里我要查询所有，如果加上skill，就变成了select * from skill where id = ?
   * @return
   */
   ...
   * 查询职位列表
   */
  public static Map<String, Object> getProfessionList(Long companyId, String companyName,
                                                      String name, String province, String city,
                                                      String county, String industry,
                                                      String category, String subCategory,
                                                      String experience, String education,
                                                      String compensation, Long updateAt,
                                                      Long recommend, Long startAt, Long endAt,
                                                      Long status) {
    ...
    if (DataUtils.isNotNullOrEmpty(industry)) {
      params.put("company_id & in ",
          "(select company_id from company_industry where industry in (" + industry + "))");
    }
   ...
   * 查询公司列表
   */
  public static Map<String, Object> getCompanyMangerList(String name, String product,
                                                         String province, String city,
                                                         String county, Long industry,
                                                         Long financing, Long freezed,
                                                         Long approved) {
  ...
  public static Map<String, Object> getArticleList(String title, String author, Long startAt,
                                                   Long endAt, Long type, Long status,
                                                   Long industry) {
    Map<String, Object> params = new HashMap<String, Object>();
   ...
   * 查询候选人列表
   */
  public static Map<String, Object> getCandidateList(String name, String phone, String status,
                                                     String occupationType, Long reserveFrom,
                                                     Long reserveTo, boolean count) {
    Map<String, Object> params = new HashMap<String, Object>();
    if (DataUtils.isNotNullOrEmpty(name)) {
      params.put("name & like ", "'%" + name + "%'");
    }
   ...
   * 查询推荐人列表
   */
  public static Map<String, Object> getRecommendList(String name, String occupationType,
                                                     String company, Long recommendFrom,
                                                     Long recommendTo, Long reserveFrom,
                                                     Long reserveTo, Long salaryFrom, Long salaryTo,
  ...
  public static Map<String, Object> getTalentList(String name, String occupationType, String degree,
                                                  String workExperience, String workSalary,
                                                  String workStatus, String talentLevel,
                                                  String recommendNum, String isRecommend,
                                                  Long candidateId, boolean count) {
    Map<String, Object> params = new HashMap<String, Object>();
    if (DataUtils.isNotNullOrEmpty(name)) {
      params.put("name & like", "'%" + name + "%'");
    }
    ...
    if (DataUtils.isNotNullOrEmpty(recommendNum)) {
      params.put("recommond_num", recommendNum);
    }
    if (DataUtils.isNotNullOrEmpty(isRecommend)) {
      params.put("is_recommond", isRecommend);
    }

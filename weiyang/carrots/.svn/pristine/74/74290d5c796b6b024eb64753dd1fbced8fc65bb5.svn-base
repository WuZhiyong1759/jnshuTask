	...
	<json:property name="message">
		...
		<json:object name="data">
			<json:object name="company">
                    ...
                    <json:property name = "userNumber" value="${company.userNumber }"></json:property>
                    
                    <json:property name = "profit" value="${company.profit }"></json:property>
                    
                    <json:property name = "companyWelfare" value="${company.companyWelfare }"></json:property>
                    
                    <json:property name = "summary" value="${company.summary }"></json:property>
                    
                    <json:property name = "companyLable" value="${company.companyLable }"></json:property>
                    
                    <json:property name = "companyRelation" value="${company.companyRelation }"></json:property>

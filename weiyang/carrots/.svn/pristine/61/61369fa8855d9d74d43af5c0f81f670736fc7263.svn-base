...
public class DynamicUtil {
	...
	public static Map<String, Object> getProfessionList(Long companyId, String companyName, String name,
			String province, String city, String county, String industry, String[] category, String[] subCategory,
			String experience, String education, String compensation, Long updateAt, Long recommend, Long startAt,
			Long endAt) {
	...
	public static Map<String, Object> getCompanyList(String name, String product, String province, String city,
			String county, String industry, String financing, Long freezed, Long approved, Long returnPage,
			Long updateTimeType) {
	...
	public static Map<String, Object> getTalentList(String talentLevel) {
		Map<String, Object> params = new HashMap<String, Object>();
		if (DataUtils.isNotNullOrEmpty(talentLevel)) {
			params.put("talent_level", talentLevel);
		}

		params.put("is_shelve", "0");

...
function projectRouteConfig($stateProvider, $urlRouterProvider, $ocLazyLoadProvider) {
    ...
    $stateProvider
        ...
        .state('field.dashboard', {
           ...
           //教材管理
        .state('field.professionLabelList', {
            url: '/professionLabelList',
            templateUrl: 'views/professionLabelList.html',
            controller: 'ProfessionLabelListController',
            controllerAs: 'vm',
            resolve: {
                loadMyFile: _lazyLoad([
                    'js/controllers/professionLabel/professionLabelListController.js'
                ])
            }
        })
        //教材编辑等管理
        .state('field.professionLabelDetails', {
            url: '/professionLabelDetails/:id',
            templateUrl: 'views/professionLabelDetails.html',
            controller: 'ProfessionLabelDetailController',
            controllerAs: 'vm',
            resolve: {
                loadMyFile: _lazyLoad([
                    'js/controllers/professionLabel/professionLabelDetailsController.js'
                ])
            }
        })      

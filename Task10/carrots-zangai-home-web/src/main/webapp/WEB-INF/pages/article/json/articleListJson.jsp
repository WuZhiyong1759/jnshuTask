	...
	<json:array name="data">
		<c:forEach items="${articleList}" var="article">
			<json:object>
                    ...
                    <json:property name="image" value="${article.image}"></json:property>
                    ...
                    <json:property name="statu" value="${article.statu}"></json:property>
                    ...
                    <json:property name="indexId" value="${article.indexId}"></json:property>

...
public class HomeController {
    ...
    public String upLoadImages(String file) throws ClassNotFoundException, UnsupportedLookAndFeelException, InstantiationException, IllegalAccessException {
    ...
    public String deleteImages(String file){

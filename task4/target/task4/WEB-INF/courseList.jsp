...
<%@ page import="cn.li.task4.entity.Profession" %>
<html>
<head>
    <meta charset="utf-8">
    <title>无标题文档</title>
...
<div class="container">
    ...
    <div class="nav-bar">
        ...
        <%
            ...
            for(int i=0;i<titleList.length;i++){
                if(i==selectNum){     %>
        <a class="nav-bar-a a-selected" href="/courseList?type=<%=i%>"><%=titleList[i]%></a>
            <%}else{%>
        <a class="nav-bar-a" href="/courseList?type=<%=i%>"><%=titleList[i]%></a>
            <%}}%>
    </div>
      <%
    ...
    <%
        List<Profession> professionsList=(List) list.get(i-1);
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 top-margin">
            ...
            <div class="warp-border">
                <div class="clearfix">
                    ...
                    <div class="text"><h4 class=""><%=profession.getV_name()%></h4>
                        <p class="text-present"><%=profession.getIntroducer()%></p>
                    </div>
                </div>
    <div class="warp-class2">
        <div class="warp-class2-text">
            <div class="iconfont text-padding">门槛
                <%
                    int step_diff = profession.getStu_diff();
...
<%
                            for(int j=0;j<profession.getStu_diff();j++){
...
%>
                ...
                <div class="warp-class2">
                    <div class="warp-class2-text">
                        <div class="iconfont text-padding">成长周期 <span class="iconfont-color"><%=profession.getStu_cyle()%></span>年</div>
                    </div>
                    <div class="warp-class2-text">
                        <div class="iconfont text-padding text-border-left">稀缺程度 <span class="iconfont-color"><%=profession.getCom_count()%></span>家公司需要
                        </div>
                    </div>
                </div>
                ...
                <div class="warp-class2">
                    ...
                    <div class="rightWarp">
                        <div class="rightWarp-class">
                            ...
                            <div class="rightWarp-wages"><%=profession.getSalary_low()%>/月</div>
                        </div>
                        <div class="rightWarp-class">
                            <div class="rightWarp-year">1-3年</div>
                            <div class="rightWarp-wages"><%=profession.getSalary_mid()%>/月</div>
                        </div>
                        <div class="rightWarp-class border-bottom">
                            <div class="rightWarp-year">3年以上</div>
                            <div class="rightWarp-wages"><%=profession.getSalary_high()%>/月</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="warp-class2">
                    <p class="text-p">提示:<%=profession.getTip()%></p>
                </div>

                <div class="flip-container">
                    <p class="flip-title"><%=profession.getV_name()%></p>
                    <p class="flip-text"><%=profession.getDetail_introduce()%></p>
                </div>
            </div>
...
<%}}} else{ %>
    <div class="caption"><h4><%=titleList[selectNum]%></h4></div>
        <%
        List<Profession> professionList = (List) list.get(selectNum-1);
    ...
    <div class="row">
        ...
        <div class="warp-border">
            <div class="clearfix">
                <div class="icon-people"><img src="/imges/687.png"></div>
                <div class="text">
                    <h4 class=""><%=profession.getV_name()%></h4>
                    <p class="text-present"><%=profession.getIntroducer()%></p>
                </div>
            </div>
        </div>
        ...
        <div class="warp-class2">
            <div class="warp-class2-text">
                <div class="iconfont text-padding">门槛
                    <%
                        int step_diif = profession.getStep_diif();
                        for (int j = 0;j<step_diif;j++){%>
                    <img src="/imges/xx.png">
                    <%}%>
                </div>
            </div>

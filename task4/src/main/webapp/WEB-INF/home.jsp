...
<%@ page import="cn.li.task4.entity.Student" %>
<%@ page import="cn.li.task4.util.ProfeesionUtil" %>
            ...
            <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div>
                    ...
                    <%
                        ...
                        ProfeesionUtil util = new ProfeesionUtil();
                        course_type = util.ProfessionNameToStringWithType(s.getCourse_type());
                    %>
